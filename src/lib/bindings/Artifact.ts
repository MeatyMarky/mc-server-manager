...
export type Artifact = { url: string, fileName: string, kind: ArtifactKind, sha1: string | null, sha256: string | null, 
/**
 * Modrinth publishes SHA-512; everything else uses one of the others.
 */
sha512: string | null, md5: string | null, size: number | null, 
/**
